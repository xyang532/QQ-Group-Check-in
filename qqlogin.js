...
RSA = function() {
    ...
    function $(t) {
        ...
        if (r-->0) for (s < this.DB && (i = this[r] >> s) > 0 && (o = !0, p = u(i)); r >= 0;) s < e ? (i = (this[r] & (1 << s) - 1) << e - s, i |= this[--r] >> (s += this.DB - e)) : (i = this[r] >> (s -= e) & n, s <= 0 && (s += this.DB, --r)),
        i > 0 && (o = !0),
        o && (p += u(i));
        return o ? p: "0"
    }
        ...
        if (! (n.t <= 0)) {
            ...
            if (0 != g) {
                ...
                for (; --$ >= 0;) {
                    ...
                    if ((i[m] += p.am(0, y, i, $, 0, u)) < y) for (p.dlShiftTo($, v), i.subTo(v, i); i[m] < --y;) i.subTo(v, i)
                }
    ...
    var pt;
    "Microsoft Internet Explorer" == navigator.appName ? (r.prototype.am = l, pt = 30) : "Netscape" != navigator.appName ? (r.prototype.am = a, pt = 26) : (r.prototype.am = c, pt = 28),
    r.prototype.DB = pt,
    ...
    if (null == ut) {
        ...
        for (; gt < ft;) dt = Math.floor(65536 * Math.random()),
        ut[gt++] = dt >>> 8,
        ut[gt++] = 255 & dt;
        gt = 0,
        Z()
...
function(t) {
    ...
    function s(t) {
        var e, i, n = [],
        o = t.length;
        for (e = 0; e < o; e++) i = t.charCodeAt(e),
    ...
    function a(t) {
        ...
        for (n = 1; n <= 2;) _ < 8 && (m[_++] = 255 & e(), n++),
        8 == _ && c();
        for (var o = 0; i > 0;) _ < 8 && (m[_++] = t[o++], i--),
        8 == _ && c();
        for (n = 1; n <= 7;) _ < 8 && (m[_++] = 0, n++),
        8 == _ && c();
        return w
    }
    function l(t) {
        ...
        v = 8,
        _++;
        for (var p = 1; p <= 2;) if (_ < 8 && (_++, p++), 8 == _ && (i = t, !d())) return null;
        for (var o = 0; 0 != e;) if (_ < 8 && (w[o] = 255 & (i[y + _] ^ $[_]), o++, e--, _++), 8 == _ && (i = t, y = v - 8, !d())) return null;
        for (p = 1; p < 8; p++) {
            if (_ < 8) {
    ...
    function c() {
        ...
        for (var e = u(m), t = 0; t < 8; t++) w[v + t] = e[t] ^ $[t],
        $[t] = m[t];
        y = v,
        v += 8,
        _ = 0,
    ...
    function u(t) {
        for (var e = 16,
        o = i(t, 0, 4), p = i(t, 4, 4), r = i(f, 0, 4), s = i(f, 4, 4), a = i(f, 8, 4), l = i(f, 12, 4), c = 0; e-->0;) c += 2654435769,
        c = (4294967295 & c) >>> 0,
        o += (p << 4) + r ^ p + c ^ (p >>> 5) + s,
        o = (4294967295 & o) >>> 0,
        p += (o << 4) + a ^ o + c ^ (o >>> 5) + l,
    ...
    function g(t) {
        for (var e = 16,
        o = i(t, 0, 4), p = i(t, 4, 4), r = i(f, 0, 4), s = i(f, 4, 4), a = i(f, 8, 4), l = i(f, 12, 4), c = 3816266640; e-->0;) p -= (o << 4) + a ^ o + c ^ (o >>> 5) + l,
        p = (4294967295 & p) >>> 0,
        o -= (p << 4) + r ^ p + c ^ (p >>> 5) + s,
        o = (4294967295 & o) >>> 0,
        c -= 2654435769,
    ...
    q.encode = function(t) {
        ...
        for (e = 0; e < s; e += 3) i = p(t, e) << 16 | p(t, e + 1) << 8 | p(t, e + 2),
...
function h(e, i, n, o) {
    ...
    return btoa(g(h)).replace(/[\/\+=]/g, function(t) {
        return {
            "/": "-",
            "+": "*",
            "=": "_"
...
function my_getEncPass(pass, salt, code) {
